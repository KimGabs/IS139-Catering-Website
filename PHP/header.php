			...
			<div class="col-3">
				<nav class="navbar navbar-expand-lg">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						<li><a href="public/others/aboutUs.php">About Us</aß></li>
						<li><a href="public/others/contactUs.php">Contact Us</a></li>
					</ul>
				</nav>
			</div>
			<div class="navbar-cart col-1">
					<div class='cart-icon'><a href='public/cart.php'><img src='../img/cart.png' alt='My Cart'></a></div>
			</div>
		</div>
	</section>
</header>
